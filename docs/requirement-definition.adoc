...
image::../images/use-cases/GuestUseCaseDiagram.png[Diagrama de casos de uso del AC-01 Huésped, width=600, align=center]

==== Casos de uso del AC-02 Recepcionista
image::../images/use-cases/ReceptionistUseCaseDiagram.png[Diagrama de casos de uso del AC-02 Recepcionista, width=600, align=center]

==== Casos de uso del AC-03 Administrador
image::../images/use-cases/AdministratorUseCaseDiagram.png[Diagrama de casos de uso del AC-03 Administrador, width=600, align=center]

==== Casos de uso del AC-04 Auditor
image::../images/use-cases/AuditorUseCaseDiagram.png[Diagrama de casos de uso del AC-04 Auditor, width=600, align=center]

==== Casos de uso del AC-05 RRHH
image::../images/use-cases/HumanResourcesUseCaseDiagram.png[Diagrama de casos de uso del AC-05 RRHH, width=600, align=center]
