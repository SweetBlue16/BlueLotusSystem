...
La Matriz de Trazabilidad Arquitectónica del *BlueLotus System* establece la relación directa entre los *impulsores arquitectónicos* (ASRs) —particularmente los escenarios de calidad (QAS)— y las *decisiones de diseño* ya documentadas lo que permite verificar cómo cada requisito de calidad se ha abordado en el diseño del sistema, así como rastrear el **por qué**, el **cómo** y el **qué** de cada decisión tomada durante el proceso arquitectónico:
...
El propósito de esta matriz es demostrar la coherencia del diseño, asegurando que cada atributo de calidad definido tenga una correspondencia tangible en el modelo arquitectónico que se ha desarrollado.
