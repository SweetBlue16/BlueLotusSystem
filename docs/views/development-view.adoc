...
image::../images/component/AuditModuleComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Auditoría"]

==== Diagrama de Especificación de Componentes del Módulo de Inventario
image::../images/component/InventoryManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Inventario"]

==== Diagrama de Especificación de Componentes del Módulo de Pagos
image::../images/component/PaymentManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Pagos"]

==== Diagrama de Especificación de Componentes de la Pasarela de Pagos
image::../images/component/PaymentServiceComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes de la Pasarela de Pagos"]

==== Diagrama de Especificación de Componentes del Módulo de Reportes
image::../images/component/ReportManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Reportes"]

==== Diagrama de Especificación de Componentes del Módulo de Reservaciones
image::../images/component/ReservationManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Reservaciones"]

==== Diagrama de Especificación de Componentes del Módulo de Estancias
image::../images/component/StaysManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Estancias"]

==== Diagrama de Especificación de Componentes del Módulo de Usuarios
image::../images/component/UserManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Usuarios"]

==== Diagrama de Especificación de Componentes del Módulo de Catálogo
image::../images/component/CatalogManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Catálogo"]

==== Diagrama de Especificación de Componentes del Módulo de Reseñas
image::../images/component/ReviewManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Reseñas"]

==== Diagrama de Especificación de Componentes del Módulo de Incidentes
image::../images/component/IncidentManagerComponent.png[width=600,align="center",alt="Diagrama de Especificación de Componentes del Módulo de Incidentes"]
...
image::../images/interfaces/IAuditoriaSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IAuditoría"]
...
image::../images/interfaces/IAutenticaciónSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IAutenticación"]
...
image::../images/interfaces/ICatálogoSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de ICatálogo"]
...
image::../images/interfaces/ICheckInSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de ICheckIn"]
...
image::../images/interfaces/ICheckOutSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces ICheckOut"]
...
image::../images/interfaces/IClienteSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de ICliente"]
...
image::../images/interfaces/IConsultaDisponibilidadSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IConsultaDisponibilidad"]
...
image::../images/interfaces/IGestionEstanciaSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IGestionEstancias"]
...
==== Diagrama de Especificación de Interfaces de IGestiónIncidentes
image::../images/interfaces/IGestiónIncidentesSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IGestiónIncidentes"]

==== Especificación de las Operaciones de IGestiónIncidentes
[cols="^20,<40,<40", options="header"]
|===
| Operación | Precondiciones | Postcondiciones
| registrarIncidente() |
- El usuario autenticado tiene rol 'Recepcionista'. +
- atosIncidente.idHotel existe. +
- Si se provee datosIncidente.idEstancia, esta debe existir y estar 'Activa'. +
- datosIncidente.descripcion no está vacía.
|
- Se crea una nueva instancia de IncidenteInfo. +
- estado se establece en 'Abierto'. +
- reportadoPor se establece con el ID del usuario autenticado. +
- fechaHora se establece a la fecha/hora actual. +
- El valor de retorno (ResultadoIncidente) indica exito = true y el idIncidente. +
- Se registra el evento en IAuditoria. +
- Si falla, retorna exito = false y mensajeError.
| resolverIncidente() |
- Existe un IncidenteInfo (incidente) con el idIncidente dado. +
- incidente.estado es 'Abierto'.
|
- El incidente.estado se actualiza a 'Cerrado'. +
- incidente.resolucion se actualiza con el texto proporcionado. +
- El valor de retorno (ResultadoOperacion) indica exito = true. +
- Se registra el evento en IAuditoria. +
- Si falla, retorna exito = false y mensajeError.
| consultarIncidentesAbiertos() |
- El idHotel existe. +
- El usuario autenticado tiene permisos.
|
- Retorna una lista (list<IncidenteInfo>) donde idHotel coincide y estado = 'Abierto'. +
- Si no hay, retorna una lista vacía. +
- El estado del sistema no cambia.
|===

==== Diagrama de Especificación de Interfaces de IGestiónMétodosPago
image::../images/interfaces/IGestiónMétodosPagoSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IGestiónMétodosPago"]

==== Especificación de las Operaciones de IGestiónMétodosPago
[cols="^20,<40,<40", options="header"]
|===
| Operación | Precondiciones | Postcondiciones
| agregarMétodoPago() |
- El idCliente en datosMetodo existe. +
- Los datos de la tarjeta son válidos. +
- El usuario autenticado es el idCliente o un rol autorizado.
|
- Se llama a IPasarelaPago::autorizarPago para validar y tokenizar la tarjeta. +
- Se crea una nueva instancia de MetodoPagoInfo guardando únicamente datos seguros. +
- El valor de retorno (ResultadoMetodoPago) indica exito = true y el idMetodoPago. +
- Se registra el evento en IAuditoria. +
- Si la tokenización falla, retorna exito = false y mensajeError.
| eliminarMétodoPago() |
- El idMetodoPago existe. +
- El usuario autenticado es el dueño del método de pago.
|
- La instancia MetodoPagoInfo correspondiente se elimina. +
- El valor de retorno (ResultadoOperacion) indica exito = true. +
- Se registra el evento en IAuditoria. +
- Si falla, retorna exito = false y mensajeError.
| listarMétodosPago() |
- El idCliente existe. +
- El usuario autenticado es el idCliente.
|
- Retorna una lista (list<MetodoPagoInfo>) de los métodos guardados para ese idCliente. +
- El estado del sistema no cambia.
|===

==== Diagrama de Especificación de Interfaces de IGestiónPersonal
image::../images/interfaces/IGestiónPersonalSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IGestiónPersonal"]
...
==== Diagrama de Especificación de Interfaces de IGestiónReseñas
image::../images/interfaces/IGestiónReseñasSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IGestiónReseñas"]

==== Especificación de las Operaciones de IGestiónReseñas
[cols="^20,<40,<40", options="header"]
|===
| Operación | Precondiciones | Postcondiciones
| crearReseña() |
- El idReservacion existe. +
- La reservación (consultada a IReservacion) tiene estado = 'Finalizada'. +
- El cliente autenticado es el dueño de la reservación. +
- No existe otra ReseñaInfo para esta idReservacion. +
- datosReseña.calificacion está en el rango [1, 5].
|
- Se crea una nueva instancia de ReseñaInfo con los datos proporcionados. +
- El valor de retorno (ResultadoReseña) indica exito = true y el idReseña. +
- Se registra el evento en IAuditoria. +
- Si falla, retorna exito = false y mensajeError.
| obtenerReseñasPorHotel() |
- El idHotel existe.
|
- Retorna una lista (list<ReseñaInfo>) de todas las reseñas asociadas a ese idHotel. +
- Si no hay, retorna una lista vacía. +
- El estado del sistema no cambia.
|===

==== Diagrama de Especificación de Interfaces de IGestiónTarifas
image::../images/interfaces/IGestiónTarifasSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces de IGestiónTarifas"]

==== Especificación de las Operaciones de IGestiónTarifas
[cols="^20,<40,<40", options="header"]
|===
| Operación | Precondiciones | Postcondiciones
| establecerTarifaDiaria() |
- El usuario autenticado tiene rol 'Administrador'. +
- El idTipoHabitacion debe existir en el inventario. +
- La fecha es una fecha válida. +
- El precio debe ser un valor monetario no negativo.
|
- Se crea o actualiza un registro TarifaEspecialInfo para el idTipoHabitacion y fecha dados con el precio especificado. +
- El valor de retorno (ResultadoOperacion) indica exito = true. +
- Se registra el evento en IAuditoria. +
- Si falla una precondición, retorna exito = false y mensajeError.
| establecerTarifaRango() |
- El usuario autenticado tiene rol 'Administrador'. +
- El idTipoHabitacion debe existir. +
- fechaInicio y fechaFin definen un rango válido (fechaInicio <= fechaFin). +
- El precio debe ser un valor monetario no negativo.
|
- Se crean o actualizan múltiples registros TarifaEspecialInfo, uno por cada día en el rango de fechas. +
- El valor de retorno (ResultadoOperacion) indica exito = true. +
- Se registra el evento en IAuditoria. +
- Si falla, retorna exito = false y mensajeError.
| consultarTarifaEfectiva() |
- El idTipoHabitacion debe existir. +
- La fecha es válida.
|
- Retorna el precioEspecial del TarifaEspecialInfo si existe uno para esa fecha y idTipoHabitacion. +
- Si no existe, consulta IInventario y retorna la tarifaBase del TipoHabitacionInfoInventario correspondiente. +
- El estado del sistema no cambia.
|===

==== Diagrama de Especificación de Interfaces IInventario
image::../images/interfaces/IInventarioSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IInventario"]
...
image::../images/interfaces/IPagoSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IPago"]
...
image::../images/interfaces/IPasarelaPagoSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IPasarelaPago"]
...
image::../images/interfaces/IRegistroSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IRegistro"]
...
image::../images/interfaces/IReporteAuditoríaSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IReporteAuditoría"]
...
image::../images/interfaces/IReporteFinancieroSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IReporteFinanciero"]
...
image::../images/interfaces/IReservaciónSpecification.png[width=600,align="center",alt="Diagrama de Especificación de Interfaces IReservación"]
...
- El idCliente proporcionado debe existir. +
- El usuario autenticado debe tener permisos para ver las reservaciones de este idCliente (ser el mismo cliente o un rol autorizado).
|
- Se retorna una lista (list<ReservacionInfo>) con todas las reservaciones (pasadas, presentes y futuras) asociadas al idCliente. +
- Si no se encuentran reservaciones, se retorna una lista vacía. +
- El estado del sistema no cambia.
|===
...
image::../images/interaction/IniciarSesionInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IAutenticación - iniciarSesión"]

==== Diagramas de Interacción de Componentes para ICatálogo

**Agregar Ítem al Catálogo**

image::../images/interaction/AgregarItemCatálogoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICatálogo - agregarItemCatálogo"]

**Modificar Ítem del Catálogo**

image::../images/interaction/ModificarItemCatálogoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICatálogo - modificarItemCatálogo"]

**Eliminar Ítem del Catálogo**

image::../images/interaction/EliminarItemCatálogoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICatálogo - eliminarItemCatálogo"]

==== Diagramas de Interacción de Componentes para ICheckIn

**Realizar Check-In**

image::../images/interaction/RealizarCheckInInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICheckIn - realizarCheckIn"]

==== Diagramas de Interacción de Componentes para ICheckOut

**Realizar Check-Out**

image::../images/interaction/RealizarCheckOutInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICheckOut - realizarCheckOut"]

**Obtener Detalle de Cargos de Estancia**

image::../images/interaction/ObtenerDetalleCargosEstanciasInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICheckOut - obtenerDetalleCargosEstancia"]

==== Diagramas de Interacción de Componentes para ICliente

**Actualizar Datos de Cliente**

image::../images/interaction/ActualizarDatosClienteInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para ICliente - actualizarDatosCliente"]

==== Diagramas de Interacción de Componentes para IConsultaDisponibilidad

**Consultar Disponibilidad**

image::../images/interaction/ConsultarDisponibilidadInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IConsultaDisponibilidad - consultarDisponibilidad"]

==== Diagramas de Interacción de Componentes para IGestionEstancias

**Registrar Consumo en Estancia**

image::../images/interaction/RegistrarConsumoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestionEstancias - registrarConsumoEstancia"]

**Cambiar Habitación de Estancia**

image::../images/interaction/CambiarHabitacionInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestionEstancias - cambiarHabitacion"]

**Extender estancia**

image::../images/interaction/ExtenderEstanciaInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestionEstancias - extenderEstancia"]

==== Diagramas de Interacción de Componentes para IGestiónIncidentes

**Registrar Incidente**

image::../images/interaction/RegistrarIncidenteInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónIncidentes - registrarIncidente"]

==== Diagramas de Interacción de Componentes para IGestiónMétodosPago

**Agregar Método de Pago**

image::../images/interaction/AgregarMétodoPagoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónMétodosPago - agregarMétodoPago"]

**Eliminar Método de Pago**

image::../images/interaction/EliminarMétodoPagoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónMétodosPago - eliminarMétodoPago"]

==== Diagramas de Interacción de Componentes para IGestiónPersonal

**Crear Perfil de Personal**

image::../images/interaction/CrearPerfilPersonalInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónPersonal - crearPerfilPersonal"]

**Modificar Perfil de Personal**

image::../images/interaction/ModificarPerfilPersonalInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónPersonal - modificarPerfilPersonal"]

**Eliminar Perfil de Personal**

image::../images/interaction/EliminarPerfilPersonalInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónPersonal - eliminarPerfilPersonal"]

==== Diagramas de Interacción de Componentes para IGestiónReseñas

**Crear Reseña**

image::../images/interaction/CrearReseñaInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónReseñas - crearReseña"]


==== Diagramas de Interacción de Componentes para IGestiónTarifas

**Establecer Tarifa Diaria**

image::../images/interaction/EstablecerTarifaDiariaInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónTarifas - establecerTarifaDiaria"]

**Establecer Tarifa por Rango de Fechas**

image::../images/interaction/EstablecerTarifaRangoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IGestiónTarifas - establecerTarifaRango"]
...
image::../images/interaction/AgregarHotelInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - agregarNuevoHotel"]

**Modificar Información de Hotel**

image::../images/interaction/ModificarHotelInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - modificarInformaciónHotel"]

**Registrar Nuevo Tipo de Habitación**

image::../images/interaction/CrearTipoHabitaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - registrarNuevoTipoHabitacion"]

**Modificar Tipo de Habitación**

image::../images/interaction/ModificarTipoHabitaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - modificarTipoHabitacion"]

**Registrar Nueva Habitación**

image::../images/interaction/RegistrarHabitaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - registrarNuevaHabitacion"]

**Modificar Información de Habitación**

image::../images/interaction/ModificarHabitaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - modificarInformaciónHabitacion"]

**Cambiar Estado de Habitación**

image::../images/interaction/CambiarEstadoHabitaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IInventario - cambiarEstadoHabitacion"]

==== Diagramas de Interacción de Componentes para IPago

**Iniciar Proceso de Pago**

image::../images/interaction/IniciarProcesoPagoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IPago - iniciarProcesoPago"]

**Consultar Estado de Pago**

image::../images/interaction/ConsultarEstadoPagoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IPago - consultarEstadoPago"]

**Registrar Pago Externo**

image::../images/interaction/RegistrarPagoExternoInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IPago - registrarPagoExterno"]

==== Diagramas de Interacción de Componentes para IRegistro

**Registrar Nuevo Huésped**

image::../images/interaction/RegistrarNuevoHuespedInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IRegistro - registrarNuevoHuesped"]
...
image::../images/interaction/GenerarReporteAccesosInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReporteAuditoría - generarReporteAccesos"]

**Generar Reporte de Auditoría**

image::../images/interaction/GenerarReporteActividadInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReporteAuditoría - generarReporteAuditoria"]


**Generar Reporte de Cancelaciones**

image::../images/interaction/GenerarReporteCancelacionesReembolsosInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReporteAuditoría - generarReporteCancelaciones"]

**Generar Reporte de Trazabilidad de Entidad**

image::../images/interaction/GenerarTrazabilidadEntidadInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReporteAuditoría - generarReporteTrazabilidadEntidad"]

==== Diagramas de Interacción de Componentes para IReporteFinanciero

**Generar Reporte de Ingresos por Período**

image::../images/interaction/GenerarReporteIngresosInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReporteFinanciero - generarReporteIngresosPorPeriodo"]

==== Diagramas de Interacción de Componentes para IReservación

**Crear Reservación**

image::../images/interaction/CrearReservaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReservación - crearReservacion"]


**Cancelar reservación**

image::../images/interaction/CancelarReservaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReservación - cancelarReservacion"]

**Obtener Detalle de Reservación**

image::../images/interaction/ObtenerDetallesReservaciónInteraction.png[width=600,align="center",alt="Diagrama de Interacción de Componentes para IReservación - obtenerDetalleReservacion"]
