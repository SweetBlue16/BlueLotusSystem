...
- Hay disponibilidad para idTipoHabitacion en el idHotel durante el rango de fechas especificado. +
- Debe existir ClienteInfo del idCliente dado.
|
...
|cancelarReservacion()|
- Existe un ReservacionInfo con el idReservacion elegido. +
- fechaFin de ReservacionInfo no expirada. +
- Las
|
-
