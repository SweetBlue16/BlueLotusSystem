...
image::../images/sequence/CrearReservacionSequence.png[Crear Reservación - Diagrama de Secuencia, width=600]
...
image::../images/sequence/ConsultarDisponibilidadSequence.png[Consultar Disponibilidad - Diagrama de Secuencia, width=600]
...
image::../images/sequence/IniciarProcesoPagoSequence.png[Iniciar Proceso de Pago - Diagrama de Secuencia, width=600]
