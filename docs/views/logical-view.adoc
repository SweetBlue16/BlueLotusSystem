...
image::../images/other/ArchitectureStyleModel.png[Estructura Estática del Sistema, width=600, align="center"]
...
image::../images/other/BusinessConceptModel.png[Modelo de Conceptos del Negocio, width=600, align="center"]
...
image::../images/other/ActorRelationshipsModel.png[Modelo de Relaciones de Actores, width=600, align="center"]
